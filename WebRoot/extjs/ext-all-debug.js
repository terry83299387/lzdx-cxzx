...
Ext.util.JSON = new (function(){
    ...
    // change by liujie. support upload file.
...
Ext.Shadow.prototype = {
    ...
    realign : function(l, t, w, h){
        ...
        // add by liujie .2010-09-10
		if (w == 0 || h == 0) {
			w = Ext.ux.Util.getDefaultWidth();
			h = Ext.ux.Util.getDefaultHeight();
		}
		// end.
...
Ext.layout.FormLayout = Ext.extend(Ext.layout.AnchorLayout, {
    ...
    labelSeparator : ':',
        ...
        if(ct.hideLabels){
            ...
            ct.labelWidth = ct.labelWidth ||20;
...
Ext.MessageBox = function(){
    ...
    return {
        ...
        getDialog : function(titleText, value){
           if(!dlg){
                dlg = new Ext.Window({
        ...
        // add value in options. liujie. 2010-09-14
        show : function(options){
            if(this.isVisible()){
                this.hide();
            }
            opt = options;
            var d = this.getDialog(opt.title || "&#160;" , opt.value);
        ...
        // add msg, regex. by liujie. 2010-09-14
         prompt : function(title, msg, defaultText, fn, scope, multiline){
        	// add by liujie. support old messagebox
